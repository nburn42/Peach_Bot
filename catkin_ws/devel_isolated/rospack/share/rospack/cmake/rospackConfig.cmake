...
if("TRUE" STREQUAL "TRUE")
  set(rospack_SOURCE_PREFIX /home/ubuntu/Peach_Bot/catkin_ws/src/rospack)
  set(rospack_DEVEL_PREFIX /home/ubuntu/Peach_Bot/catkin_ws/devel_isolated/rospack)
...
if(NOT "/home/ubuntu/Peach_Bot/catkin_ws/src/rospack/include;/usr/include " STREQUAL " ")
  set(rospack_INCLUDE_DIRS "")
  set(_include_dirs "/home/ubuntu/Peach_Bot/catkin_ws/src/rospack/include;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rospack' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/Peach_Bot/catkin_ws/src/rospack/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
    _list_append_unique(rospack_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "rospack;/usr/lib/aarch64-linux-gnu/libpython2.7.so;/usr/lib/aarch64-linux-gnu/libboost_filesystem.so;/usr/lib/aarch64-linux-gnu/libboost_program_options.so;/usr/lib/aarch64-linux-gnu/libboost_system.so;/usr/lib/aarch64-linux-gnu/libtinyxml.so")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ubuntu/Peach_Bot/catkin_ws/devel_isolated/rospack/lib;/opt/ros/kinetic/lib)
