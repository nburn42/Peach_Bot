...
if("TRUE" STREQUAL "TRUE")
  set(rosconsole_SOURCE_PREFIX /home/ubuntu/Peach_Bot/catkin_ws/src/ros_comm/rosconsole)
  set(rosconsole_DEVEL_PREFIX /home/ubuntu/Peach_Bot/catkin_ws/devel_isolated/rosconsole)
...
if(NOT "/home/ubuntu/Peach_Bot/catkin_ws/src/ros_comm/rosconsole/include;/usr/include " STREQUAL " ")
  set(rosconsole_INCLUDE_DIRS "")
  set(_include_dirs "/home/ubuntu/Peach_Bot/catkin_ws/src/ros_comm/rosconsole/include;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosconsole' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/Peach_Bot/catkin_ws/src/ros_comm/rosconsole/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
    _list_append_unique(rosconsole_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "rosconsole;rosconsole_print;rosconsole_backend_interface;/usr/lib/aarch64-linux-gnu/libboost_regex.so;/usr/lib/aarch64-linux-gnu/libboost_system.so;/usr/lib/aarch64-linux-gnu/libboost_thread.so;/usr/lib/aarch64-linux-gnu/libboost_chrono.so;/usr/lib/aarch64-linux-gnu/libboost_date_time.so;/usr/lib/aarch64-linux-gnu/libboost_atomic.so;/usr/lib/aarch64-linux-gnu/libpthread.so")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ubuntu/Peach_Bot/catkin_ws/devel_isolated/rosconsole/lib;/opt/ros/kinetic/lib)
