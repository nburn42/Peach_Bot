...
if("TRUE" STREQUAL "TRUE")
  set(pluginlib_SOURCE_PREFIX /home/ubuntu/Peach_Bot/catkin_ws/src/pluginlib)
  set(pluginlib_DEVEL_PREFIX /home/ubuntu/Peach_Bot/catkin_ws/devel_isolated/pluginlib)
...
if(NOT "/home/ubuntu/Peach_Bot/catkin_ws/src/pluginlib/include;/usr/include " STREQUAL " ")
  set(pluginlib_INCLUDE_DIRS "")
  set(_include_dirs "/home/ubuntu/Peach_Bot/catkin_ws/src/pluginlib/include;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pluginlib' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/Peach_Bot/catkin_ws/src/pluginlib/${idir}'.  Ask the maintainer 'Mikael Arguedas <mikael@osrfoundation.org>' to fix it.")
    endif()
    _list_append_unique(pluginlib_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "/usr/lib/aarch64-linux-gnu/libboost_filesystem.so;/usr/lib/aarch64-linux-gnu/libboost_system.so;/usr/lib/aarch64-linux-gnu/libtinyxml.so")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ubuntu/Peach_Bot/catkin_ws/devel_isolated/pluginlib/lib;/opt/ros/kinetic/lib)
