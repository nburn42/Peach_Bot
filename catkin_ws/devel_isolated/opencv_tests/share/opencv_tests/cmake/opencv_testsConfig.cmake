...
if("TRUE" STREQUAL "TRUE")
  set(opencv_tests_SOURCE_PREFIX /home/ubuntu/Peach_Bot/catkin_ws/src/vision_opencv/opencv_tests)
  set(opencv_tests_DEVEL_PREFIX /home/ubuntu/Peach_Bot/catkin_ws/devel_isolated/opencv_tests)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'opencv_tests' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/Peach_Bot/catkin_ws/src/vision_opencv/opencv_tests/${idir}'.  Ask the maintainer 'Vincent Rabaud <vincent.rabaud@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ubuntu/Peach_Bot/catkin_ws/devel_isolated/opencv_tests/lib;/opt/ros/kinetic/lib)
